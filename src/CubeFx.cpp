...
// CubeFx::CubeFx(uint8_t size)
CubeFx::CubeFx()
{
    // _size = size;
}

void CubeFx::begin(uint8_t eff)
{
...
void CubeFx::setNextEffect()
{
    setEffect(effect + 1);
}

// effects
void CubeFx::_rainbowEffect()
{
    _effectStartIndex += 1;
    _palette = RainbowColors_p;
...
void CubeFx::_rainbowVerticalEffect()
{
...
void CubeFx::_rainbowDiagonalEffect()
{
    uint8_t size = WIDTH * HEIGHT;
    _effectHue += 1;
    _palette = RainbowColors_p;
...
void CubeFx::_lineHorizontalEffect()
{
...
void CubeFx::_sparklesRoutineEffect()
{
    // _palette = RainbowColors_p;
...
void CubeFx::_colorRoutineEffect()
{
    _effectHue += 10;
    _palette = RainbowColors_p;
    _effectSpeed = EFFECT_SPEED;
...
void CubeFx::_axelColorRoutineEffect()
{
    _palette = RainbowColors_p;
    _effectSpeed = EFFECT_SPEED;
    CRGB sides[6] = {
...
void CubeFx::_snowRoutineEffect()
{
    // _palette = RainbowColors_p;
    _effectSpeed = EFFECT_SPEED;
...
void CubeFx::_matrixRoutineEffect()
{
    _palette = RainbowColors_p;
    _effectSpeed = EFFECT_SPEED;
...
void CubeFx::_rainbowNoiseEffect()
{
    _palette = RainbowColors_p;
    _effectScale = 30;
    _effectSpeed = EFFECT_SPEED;
...
void CubeFx::_rainbowStripeNoiseEffect()
{
...
void CubeFx::_forestNoiseEffect()
{
...
void CubeFx::_plasmaNoiseEffect()
{
...
// void CubeFx::flashLights(const CRGB &color)
// {
...
// utils
void CubeFx::_fillAll(CRGB color)
{
    fill_solid(_leds, NUM_LEDS, color);
}

void CubeFx::_fillFromPalette(uint8_t colorIndex)
{
...
CRGB CubeFx::_getColorForSide(int s, int brigthness)
{
    CRGB c = 0;
    if (s == 1)
    {
...
uint8_t CubeFx::_getPixelAddr(uint8_t side, int x, int y)
{
    return _matrix[side][y][x];
}

// получить номер пикселя в ленте по координатам
uint8_t CubeFx::_getPixelNumber(int8_t x, int8_t y)
{
...
uint32_t CubeFx::_getPixelColor(int segment)
{
...
uint32_t CubeFx::_getPixColorXY(int8_t x, int8_t y)
{
    return _getPixelColor(_getPixelNumber(x, y));
}

// функция отрисовки точки по координатам X Y
void CubeFx::_drawPixelXY(int8_t x, int8_t y, CRGB color)
{
...
void CubeFx::_fadePixel(byte i, byte j, byte step)
{ // новый фейдер
